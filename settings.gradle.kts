...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        // Local pins: inter-repo capullo coordinates versioned independently per release.
...
include(":capullo-tunnel") // optional public-link tunnel: cloudflared .so + TunnelManager; standalone
